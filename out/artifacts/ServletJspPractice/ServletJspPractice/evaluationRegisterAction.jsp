...
<%@ page import="com.major.servletJspPractice.common.evaluation.EvaluationDTO" %>
...
<%
    ...
    if (request.getParameter("professorName") != null) {
        profName = request.getParameter("professorName");
    }
    ...
    if ((profName == null) || (lectureName == null) || (lectureYear == 0) || (semesterDivide == null)
    ...
    int result = evaluationDAO.write(new EvaluationDTO(0l, username, lectureName, profName, lectureYear, semesterDivide,
